...
func BuildTableFrom(builder *TableBuilder) BuildTable {
...
func CloneTableFrom(original Table) BuildTable {
	return func(target *Table) {
		target.pointers = original.pointers
		target.constants = original.constants
		target.builtins = original.builtins
	}
}
